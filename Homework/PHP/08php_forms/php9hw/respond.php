...
$test_password = "money";
 ...
 if(isset($_POST["user_name"])&&isset($_POST["p_password"])&&isset($_POST["n_password"])&&isset($_POST["n_password_again"]))
				...
				else if($p_password!=$test_password || $user_name!=$test_name)
						{echo "<div style='background-color:#FF0033'>Incorrect data! You have to retype again! </br></div>";}	
						else 
						{
